...
def turnRight(firstMiniTurn, lastMiniTurn):
    if (firstMiniTurn):
        firstMiniTurnRight()
    else: 
        # Step 1: Lift and move tripod group A where legs 1 & 3 move forwards & 5 moves backwards 
