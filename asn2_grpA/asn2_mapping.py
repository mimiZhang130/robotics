...
from asn2_mapping_helpers import check_direction, turn_to_direction, forward_cell, get_opp_direction
...
def explore_from_tile(world, robot_info, walked_tiles):
    ...
    for neighbor_k in get_neighbors(i, j, world, walked_tiles):
        wall = check_direction(robot_info[2], neighbor_k)
