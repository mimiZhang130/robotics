...
if __name__ == "__main__":
    # localize()
    map = CSME301Map(2, 2)
    map.setObstacle(1, 0, 1, 1)
    map.setObstacle(1, 0, 1, 2)
    map.printObstacleMap()
    print(f"N: {map.getNeighborObstacle(0, 0, 1)}, E: {map.getNeighborObstacle(0, 0, 2)}, S: {map.getNeighborObstacle(0, 0, 3)}, W: {map.getNeighborObstacle(0, 0, 4)}")
    print(f"N: {map.getNeighborObstacle(0, 1, 1)}, E: {map.getNeighborObstacle(0, 1, 2)}, S: {map.getNeighborObstacle(0, 1, 3)}, W: {map.getNeighborObstacle(0, 1, 4)}")
    print(f"N: {map.getNeighborObstacle(1, 0, 1)}, E: {map.getNeighborObstacle(1, 0, 2)}, S: {map.getNeighborObstacle(1, 0, 3)}, W: {map.getNeighborObstacle(1, 0, 4)}")
    print(f"N: {map.getNeighborObstacle(1, 1, 1)}, E: {map.getNeighborObstacle(1, 1, 2)}, S: {map.getNeighborObstacle(1, 1, 3)}, W: {map.getNeighborObstacle(1, 1, 4)}")