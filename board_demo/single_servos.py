...
print('''
**********************************************************
********功能:幻尔科技树莓派扩展板，控制单个PWM舵机(function:Hiwonder Raspberry Pi expansion board,  single PWM servo control)**********
**********************************************************
----------------------------------------------------------
...
if __name__ == '__main__':
    while True:
        ...
        time.sleep(1)
        board.pwm_servo_set_position(1, [[1, 500]]) # 设置1号舵机脉宽为500(set the pulse width of servo 1 to 500)
        time.sleep(1)
        board.pwm_servo_set_position(1, [[1, 1000]]) # 设置1号舵机脉宽为1000(set the pulse width of servo 1 to 1000)
        time.sleep(1)
        board.pwm_servo_set_position(1, [[1, 1500]]) # 设置1号舵机脉宽为1500(set the pulse width of servo 1 to 1500)
